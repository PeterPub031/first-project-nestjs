...
-- AlterTable
ALTER TABLE "User" ADD COLUMN     "email_verify_token" TEXT NOT NULL DEFAULT '';
...
-- AddForeignKey
ALTER TABLE "cart-items" ADD CONSTRAINT "cart-items_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "cart-items" ADD CONSTRAINT "cart-items_product_id_fkey" FOREIGN KEY ("product_id") REFERENCES "Product"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "tracking_orders" ADD CONSTRAINT "tracking_orders_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
