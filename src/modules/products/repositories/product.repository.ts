...
export class ProductRepository {
    ...
    async findProductById(params: Prisma.ProductFindFirstArgs) {
        return this._model.findFirst(params);
    }

    async findProductByName(params: Prisma.ProductFindFirstOrThrowArgs) {
        return this._model.findFirstOrThrow(params);
    }

    async findAllProducts(params: Prisma.ProductFindManyArgs) {
